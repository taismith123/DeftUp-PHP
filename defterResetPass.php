...
// if defter is not logged in, redirect him/her to designated login page
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($newPassError) && empty($confirmPassError)){
        ...
        $sql = "UPDATE defters SET password = ? WHERE id = ?";
...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <a class="btn cancel" href="defterWelcome.php">Cancel</a>
        </div>
    </form>
</div>
</body>
